if True:
    ...
    def chuan_doan_du_lieu(data,model):
        ...
        roc_curve_train=roc_curve(y_train,probs_train)
        fpr_train=roc_curve_train[0]
        tpr_train=roc_curve_train[1]
        roc_curve_test=roc_curve(y_test,probs_test)
        fpr_test=roc_curve_test[0]
        tpr_test=roc_curve_test[1]
